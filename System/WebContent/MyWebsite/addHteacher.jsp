...
function test2()
{
	...
	re = /^[0-9a-zA-Z]{5,9}$/; 
		if (re.test(user)) {
			...
			document.getElementById("errorDiv2").innerHTML=  "Please input 5 digits numerics or 9 digits letters   ";
...
function test3()
{
	...
	var re;
		...
		if (re.test(user)) {
			...
			document.getElementById("errorDiv3").innerHTML=  "Please input letters from 1 to 9 digits   ";
...
function test7()
{
	...
	re = /^[0-9a-zA-Z]{1,10}$/;
		if (re.test(user)) {
			...
			//alert("Must be numerics");
			document.getElementById("errorDiv7").innerHTML=  "Please input appropriate college name ";
...
function test9()
{
	...
	re = /^([0-9a-zA-Z]{1,10})@([0-9a-zA-Z]{1,10}).([0-9a-zA-Z]{1,5})$/;
		...
		if (re.test(user)) {
			...
			//alert("Must be numerics");
			document.getElementById("errorDiv9").innerHTML= "Inappropriate Email Address " ;
...
<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
  <tr>
    <td colspan="2" background="skin/images/frame/wbg.gif" bgcolor="#EEF4EA" class='title'>
    	<div style='float:left'><span>Add the Information of Head Teacher</span></div>
   </td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
<form name='form3' action="hteacherInfo_addOne" style="margin-top:8px" >
<div id='addHteacher_list' style="margin-left:0px;">

TeacherID：<input type = "text" name = "hteacher.hteacherNumber"   id="Number" onBLur="test1()"/>
*
<div id="errorDiv1" style="color:red;font-weight:bold" ></div>
<br>
Password：<input type = "text" name = "hteacher.password" id= "thepassword" onBlur="test2()" />
*
<div id="errorDiv2" style="color:red;font-weight:bold" ></div>
<br>
FullName：<input type = "text" name = "hteacher.hteacherName" id= "name" onBlur="test3()" />
*
<div id="errorDiv3" style="color:red;font-weight:bold" ></div>
<br>
Gender：<input type = "text" name = "hteacher.sex" id="thesex" onBlur="test4()" />
<div id="errorDiv4" style="color:red;font-weight:bold" ></div>
<br>
Age：<input type = "text" name = "hteacher.age" id="theAge" onBlur="test5()"/>
<div id="errorDiv5" style="color:red;font-weight:bold" ></div>
<br>
Address：<input type = "text" name = "hteacher.address" id="theaddress" onBlur="test6()" />
<div id="errorDiv6" style="color:red;font-weight:bold" ></div>
<br>
Department：<input type = "text" name = "hteacher.department" id="thedepartment" onBlur="test7()" />
<div id="errorDiv7" style="color:red;font-weight:bold" ></div>
<br>
Status：<input type = "text" name = "hteacher.status" id="thestatus" onBlur="test8()"/>
<div id="errorDiv8" style="color:red;font-weight:bold" ></div>
<br>
Email：<input type = "text" name = "hteacher.mailAddress" id="mail" onBlur="test9()" />
*
<div id="errorDiv9" style="color:red;font-weight:bold" ></div>
<br>
ProfessionLevel：<input type = "text" name = "hteacher.professionLevel" id="level" onBlur="test10()" />
<div id="errorDiv10" style="color:red;font-weight:bold" ></div>
<br>
</div>
<div id='addHteacher_submit'><input type = "submit" value = "submit" disabled="true" id="sub"/></div>
</form>
</div>
</td>
        </tr>
