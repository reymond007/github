...
<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
  <tr>
    <td colspan="2" background="skin/images/frame/wbg.gif" bgcolor="#EEF4EA" class='title'>
    	<div style='float:left'><span>Delete Faculty Info.</span></div>
   </td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
<form name='form3' action="studentInfo_deleteOne"  align="center" style="margin-top:8px" >
 <div id='deleteHteacher'>
    Teachers'ID：<input type="text" name="teacher.teacherNumber"/><br/>
</div>
<div id='deleteHteacher'><input type = "submit" value = "Submit"/></div>
</form>
</div>
</td>
        </tr>
